public class Transport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tenzing Norgay Bus Terminus", "PC Mittal Bus Terminus"}));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bagdogra Airport" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        Stations station = new Stations(jComboBox1.getSelectedItem().toString());
        station.setVisible(true);
        this.setVisible(false);
    }
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        BusStops busstop = new BusStops(jComboBox2.getSelectedItem().toString());
        busstop.setVisible(true);
        this.setVisible(false);
    }
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        Airports airport = new Airports(jComboBox3.getSelectedItem().toString());
